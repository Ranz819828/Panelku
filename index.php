<div id="postLocker" oncontextmenu="return false">
  <div class="lockerContainer" id="postLock">
    ...
    <div class="lockerDescription">MADED BY GARIDXD 🚀🇮🇩</div>
    <input id="lockerPassword" type="text" placeholder="Input Your Password In Here....." onkeydown="if(event.keyCode==13)postLock()"/>
    <div class="lockerButton" onclick="postLock()"><i class="mainIcon lockIcon"></i>LOGIN</div>
    <div class="lockerOut">
      <a href="https://wa.me/6283899698761" title="Homepage">BELI PANEL JASTEB</a>
    </div>
  </div>
</div>
...
<script>
function postLock(){if(document.getElementById("lockerPassword").value==="GaridXD!?"){document.getElementById("lockerContent").classList.remove("contentHide");document.getElementById("postLocker").classList.add("contentHide")}else{alert("Wrong password! enter correctly!");lockerPassword.setSelectionRange(0,lockerPassword.value.length)}return false}
</script>
...
<html lang="en">
  <head>
    ...
    <title>
    Ng Script | Login Panel
    </title>
    <meta charset="UTF-8">
    <meta name="Description" content="panel ini dirancang oleh garidxd, jadi mohon di hargai:)">
...
@media (max-width: 550px) {
  ...
  <body>
    ...
    <div class="nav">
        <img class="logo" src="https://telegra.ph/file/20d231f7a978708dd3c6d.jpg">
        <div class="fill" onclick="window.location.href='https://wa.me/6283899698761;">WhastsApp</div>
        <div class="fill" onclick="window.location.href='window.location.href='index.php;">Website</div>
    </div>


    <h1>GaridXD<strong>Nesia</strong>Panel</h1>
    <div class="rainbow-text" data-splitting></div>
    <div class="rainbow-text animated" data-splitting style="margin-left:5px;">Panel Maded By GaridXD</div>
    <div class="rainbow-text" data-splitting></div>
    <div class="rainbow-text animated" data-splitting style="margin-left:5px;">Buy Script? Chat!!!</div>

        <div class="check" onclick="window.location='panel.php';">Mulai Pakai Panel</div>


     
    <span class="copy">
    PANEL MADED BY GARIDXD
    <div class="rainbow-text" data-splitting></div>
    <div class="rainbow-text animated" data-splitting style="margin-left:5px;">Wa.me/6283899698761</div>
    </span>
    </div>
